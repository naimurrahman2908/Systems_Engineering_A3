...
\begin{itemize}
    ...
    \item {Black Zone Detection and Turnaround:} Program the car to use its floor IR sensors to spot when it hits a solid black patch on the track, stop moving forward, spin 180 degrees on the spot, and follow the line back the other way.
